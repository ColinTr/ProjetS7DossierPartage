...
public class SettingWindow {
	...
	private void initialize() {
		...
		frameSettingWindow.setTitle("Database connection settings");
		...
		addressLabel = new JLabel("Connection address :");
		...
		addressField.setText(DatabaseParameters.getAddress());
		...
		accountField.setText(DatabaseParameters.getUser());
		...
		passwordField.setText(DatabaseParameters.getPassword());
		...
		btnApply.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				...
				DatabaseParameters.setUserInfo(newInfos);
				DatabaseParameters.setAddress(addressField.getText());
